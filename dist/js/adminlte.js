(function (global, factory) {
    ...
    class PushMenu {
        ...
        expand() {
            this.sidebarOpening();
            this._bodyClass.remove(CLASS_NAME_SIDEBAR_CLOSE$1);
            this._bodyClass.remove(CLASS_NAME_SIDEBAR_COLLAPSE$1);
            this._bodyClass.add(CLASS_NAME_SIDEBAR_OPEN$1);
        }
        collapse() {
            this.sidebarColllapsing();
            this._bodyClass.add(CLASS_NAME_SIDEBAR_COLLAPSE$1);
        }
        close() {
            this._bodyClass.add(CLASS_NAME_SIDEBAR_CLOSE$1);
            this._bodyClass.remove(CLASS_NAME_SIDEBAR_OPEN$1);
            this._bodyClass.remove(CLASS_NAME_SIDEBAR_COLLAPSE$1);
        ...
        toggleFull() {
            if (this._bodyClass.contains(CLASS_NAME_SIDEBAR_CLOSE$1)) {
                this.expand();
            }
            else {
                this.close();
        ...
        toggleMini() {
            ...
            if (this._bodyClass.contains(CLASS_NAME_SIDEBAR_COLLAPSE$1)) {
                this.expand();
            }
            else {
                this.collapse();
    ...
    exports.SidebarOverlay = SidebarOverlay;
